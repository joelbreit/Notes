...
- [Computer Science Flashcards](#computer-science-flashcards)
  ...
  - [Code Processing Steps](#code-processing-steps)
...
* **escape character/escape sequence**: *a character or sequence of characters that represents a special character in a string*

* **ORM (Object-Relational Mapper)**: a library that lets you work with a SQL database using objects instead of SQL
